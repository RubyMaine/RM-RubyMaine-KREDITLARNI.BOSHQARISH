...
<div class="container-fluid">
	...
	<form action="" id="loan-application">
		...
		<div class="row">
			<div class="col-md-6">
				<label class="control-label"> Заемщик: </label>
				<?php
			...
			<div class="col-md-6">
				<label class="control-label"> Тип кредита: </label>
				<?php
		...
		<div class="row">
			<div class="col-md-6">
				<label class="control-label"> Кредитный план: </label>
				<?php
				...
				<small>месяцы [ interest%,penalty% ]</small>
			</div>
		...
		<div class="form-group col-md-2 offset-md-2 .justify-content-center">
			...
			<button class="btn btn-primary btn-sm btn-block align-self-end" type="button" id="calculate"> Рассчитать! </button>
		</div>
		</div>
		...
		<div id="row-field">
			<div class="row ">
				<div class="col-md-12 text-center">
					<button class="btn btn-primary btn-sm " >Сохранять</button>
