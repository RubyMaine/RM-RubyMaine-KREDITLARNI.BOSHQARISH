	...
	<div class="col-lg-12">
		<div class="row">
			...
			<form action="" id="manage-plan">
				<div class="card">
					<div class="card-header"> Форма плана </div>
					<div class="card-body">
							<input type="hidden" name="id">
							<div class="form-group">
								<label class="control-label"> План (месяцев): </label>
								<input type="number" name="months" id="" class="form-control text-right">
							</div>
							<div class="form-group">
								<label class="control-label"> Проценты: </label>
							...
							<div class="form-group">
								<label class="control-label"> Ежемесячный штраф за просрочку платежа: </label>
								<div class="input-group">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()"> Отмена </button>
							</div>
						</div>
					</div>
				</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center"> Планирован: </th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p> Годы/Месяц: <b><?php echo $months ?></b></p>
										 <p><small> Процент: <b><?php echo $row['interest_percentage']."%" ?></b></small></p>
										 <p><small> Просроченный штраф: <b><?php echo $row['penalty_rate']."%" ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_plan" type="button" data-id="<?php echo $row['id'] ?>" data-months="<?php echo $row['months'] ?>" data-interest_percentage="<?php echo $row['interest_percentage'] ?>"> Редактировать </button>
										<button class="btn btn-sm btn-danger delete_plan" type="button" data-id="<?php echo $row['id'] ?>"> Удалить </button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_plan').click(function(){
		_conf("Вы уверены, что хотите удалить этот план?","delete_plan",[$(this).attr('data-id')])
	})
